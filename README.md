...
- یا اگر فونت شما در این لیست هست اما در آپدیت نسخه‌ی جدیدی که منتشر می‌کنید، تغییری بنیادی به وجود آمده باشد که توسط فایل `catalog.toml` قابل پشتیبانی نباشد
...
فکر می‌کنم به جز ۳ فیلد آخر بقیه‌ی فیلدها نیازی به توضیح ندارند.
...
الگوی regex مسیری که فونت‌ها در فایل zip قرار گرفته‌اند، برای مثال پس از unzip کردن vazir فونت‌ها در این مسیر قرار دارند:
