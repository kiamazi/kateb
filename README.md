...
``` bash
sudo apt install curl make git build-essential
```

- ‫در صورتی‌که از نسخه‌های قبل از اوبونتو ۲۰.۰۴ و یا سایر نسخه‌های بر پایه دبیان استفاده می‌کنید و openssl و یا کتابخانه‌های آن نصب نشده‌اند:

``` bash
sudo apt install openssl libssl-dev
```

>>> اگر از 20.04 استفاده میکنید نیازی به دستور فوق ندارید
